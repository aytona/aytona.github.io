...
export default function Nav() {
  ...
  return (
    <>
      ...
      {/* Floating nav */}
      <motion.nav
        className="fixed top-4 left-1/2 -translate-x-1/2 z-40 glass rounded-full px-3 md:px-6 py-2 flex justify-center gap-1.5 md:gap-4 max-w-[calc(100vw-1rem)] overflow-x-auto scrollbar-hide"
